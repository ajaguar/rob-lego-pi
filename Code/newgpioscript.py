...
GPIO.setup(16, GPIO.OUT) # GPIO 25 is set to be an output.

pwm = GPIO.PWM(16, 50)   # pwm is an object. This gives a neat way to control the pin.
...
pwm.ChangeFrequency(100) # Frequency is now 5.5 Hz
pwm.ChangeDutyCycle(50)  # Duty cycle is now 50%
time.sleep(3)            # Three seconds till the next change
